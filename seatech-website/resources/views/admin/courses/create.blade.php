...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route($p.'.courses.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="code" id="code" value="{{ old('code') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#0077B6] focus:ring focus:ring-[#0077B6] focus:ring-opacity-20">
            ...
            <div>
                ...
                <input type="text" name="duration" id="duration" value="{{ old('duration') }}" placeholder="e.g. 5 Days" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#0077B6] focus:ring focus:ring-[#0077B6] focus:ring-opacity-20">
            ...
            <div>
                ...
                <input type="number" name="fee" id="fee" value="{{ old('fee') }}" step="0.01" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#0077B6] focus:ring focus:ring-[#0077B6] focus:ring-opacity-20">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="prerequisites" id="prerequisites" rows="3" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#0077B6] focus:ring focus:ring-[#0077B6] focus:ring-opacity-20">{{ old('prerequisites') }}</textarea>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="learning_outcomes" id="learning_outcomes" rows="4" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-[#0077B6] focus:ring focus:ring-[#0077B6] focus:ring-opacity-20" placeholder="What will trainees be able to do after completing this course?">{{ old('learning_outcomes') }}</textarea>
        ...
        <div class="mt-6 flex space-x-3">
            <button type="submit" class="bg-[#0077B6] text-white px-6 py-2 rounded-lg text-sm hover:bg-[#005f94] transition">Save Course</button>
